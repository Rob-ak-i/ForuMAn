...
public class LineSearch {
	...
	public ArrayList<Point> dotsStorage;
	...
	private void linearizeCircuits(int scales) {
		ArrayList<Point> dotsStorageNew = new ArrayList<Point>();
		//������ ������� ����� �� �����, ������ �������+1, ����� �������� ��� �� �������� ��������(���������� ������)
			...
			if(nowCircuit.dotLinkList.size()>scales)
				for (int j =0 ; j<nowCircuit.dotLinkList.size();++j) {
					...
					if(flagContinueOnZero) {
						...
						if(flagLast) {
							flagLast=false;
							dotsStorageNew.add(new Point(tempX,tempY));
		...
		for (int i =0 ; i<circuits.size();++i) {
			...
			if(ellipseTemp!=null) {
				if(ellipseTemp.x>0 && ellipseTemp.x<width && ellipseTemp.y>0 && ellipseTemp.y<height) {
					ellipseTemp.draw(circlesMap, 0x00FF00, false);
	...
	*/
	...
	public static void drawCircle(int x,int y, int r, int color, IntMap img) {
		Ellipse.V_BRcirc(x, y, r, color, img, false);
	}
...
class Circuit{
	...
	public Ellipse analyze(ArrayList<Point> dotsStorage) {
