...
public class IntList {
	...
	public IntList(String string) {
		count=string.length();length=count;
		data=new int[count];
		for(int i=0;i<count;++i)data[i]=string.charAt(i);
	}
	...
	public boolean has(int number) {return indexOf(number, 0)!=-1;}
	public boolean has(int[] sequence) {return indexOf(sequence,sequence.length, 0)!=-1;}
	public boolean has(IntList sequence) {return indexOf(sequence.data,sequence.size(), 0)!=-1;}
	
	public int indexOf(int number) {return indexOf(number, 0);}
	...
	public int indexOf(IntList subSequence) {return indexOf(subSequence.data, subSequence.size(),0);}
	public int indexOf(int[] subSequence) {return indexOf(subSequence, subSequence.length,0);}
	public int indexOf(IntList subSequence, int indexFrom) {return indexOf(subSequence.data, subSequence.size(),indexFrom);}
	public int indexOf(int[] subSequence, int indexFrom) {return indexOf(subSequence, subSequence.length,indexFrom);}
	public int lastIndexOf(int number) {return lastIndexOf(number, count);}
	...
	public int lastIndexOf(IntList subSequence) {return lastIndexOf(subSequence.data, subSequence.size(), 0);}
	public int lastIndexOf(int[] subSequence) {return lastIndexOf(subSequence, subSequence.length, 0);}
	public int lastIndexOf(IntList subSequence, int indexFrom) {return lastIndexOf(subSequence.data, subSequence.size(), indexFrom);}
	public int lastIndexOf(int[] subSequence, int indexFrom) {return lastIndexOf(subSequence, subSequence.length, indexFrom);}
	private int lastIndexOf(int[] subSequence, int count1, int lastIndexFrom) {
		int firstFindElement=subSequence[0];//,count1=subSequence.size();
		int occurrenceIndex=-1;boolean occurenceOk;
		if(lastIndexFrom>count-count1)lastIndexFrom=count-count1;
		for(int i=lastIndexFrom;i>=0;--i) {
	...
	private int indexOf(int[] subSequence, int count1, int indexFrom) {
		int firstFindElement=subSequence[0];//,count1=subSequence.size();
		int occurrenceIndex=-1;boolean occurenceOk;
	...
	public boolean equalsSequence(IntList a) {
		if(a.data==null)return false;
		return equalsSequence(a.data);
	}
	/**used for search in ArrayList subsequence*/
	public boolean equalsSequence(int[] otherData) {
