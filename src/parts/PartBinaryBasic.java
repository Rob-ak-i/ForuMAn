...
public abstract class PartBinaryBasic extends PartBasic{
	...
	public void computeCoordinates() {
		int x0=nodeFrom.pos.x,y0=nodeFrom.pos.y,x1=nodeTo.pos.x,y1=nodeTo.pos.y;
		//x=((x0+x1)>>>1);y=((y0+y1)>>>1);
		dx=x1-x0;dy=y1-y0;
		...
		this.x0=(int) Math.round(pos.x-dx*0.5);
		this.y0=(int) Math.round(pos.y-dy*0.5);
		this.x1=(int) Math.round(pos.x+dx*0.5);
		this.y1=(int) Math.round(pos.y+dy*0.5);
	...
	public void drawOnMap(int[][] map, int caption, double camposx,double camposy,double scalex, double scaley) {
		...
		int x0=(int)(((double)nodeFrom.pos.x-camposx)*scalex+screenWidthHalf);
		int y0=(int)(((double)nodeFrom.pos.y-camposy)*scaley+screenHeightHalf);
		int x1=(int)(((double)nodeTo.pos.x-camposx)*scalex+screenWidthHalf);
		int y1=(int)(((double)nodeTo.pos.y-camposy)*scaley+screenHeightHalf);
		int x=(int)(((double)this.pos.x-camposx)*scalex+screenWidthHalf);
		int y=(int)(((double)this.pos.y-camposy)*scaley+screenHeightHalf);
