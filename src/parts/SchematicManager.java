...
public class SchematicManager {
	...
	public static ArrayList<PartBinaryBasic> binaryParts = new ArrayList<PartBinaryBasic>();
	...
	public static void drawLogicMap(double wl,double wr,double wu,double wd, double cx, double cy, double sx, double sy){
		...
		for(int i=0;i<elements.size();++i){
			...
			if(!element.getClass().equals(PartNode.class)){
				x0=((PartBinaryBasic)element).nodeFrom.pos.x;
				y0=((PartBinaryBasic)element).nodeFrom.pos.y;
				x1=((PartBinaryBasic)element).nodeTo.pos.x;
				y1=((PartBinaryBasic)element).nodeTo.pos.y;
	...
	public static int addExistingPart(PartBinaryBasic part) {
		...
		elements.add(part);
		int elementIndex=elements.size()-1;
		int partIndex=binaryParts.size()-1;
