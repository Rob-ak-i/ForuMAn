...
public class GUITableEditor extends JFrame{
	...
	private static Action showTableElements = new AbstractAction() {
		...
		public void actionPerformed(ActionEvent arg0) {
			DataTable table=CommonData.tableManager.getManagedElement(CommonData.frame2.tableName.getCaption());
	...
	private void addTableName() {
		...
		CommonData.tableManager.addControlledComboBox(tableName);
