...
public class GUISchematicEditor_Toolbar {
	...
	public static void selectButton(JButton newSelectedButton) {
		GUISchematicEditor_Toolbar.PreviousSelectedButton=GUISchematicEditor_Toolbar.SelectedButton;
		GUISchematicEditor_Toolbar.SelectedButton=newSelectedButton;
		if(newSelectedButton!=null)
			GUISchematicEditor_Toolbar.SelectedButton.setSelected(true);
		if(GUISchematicEditor_Toolbar.PreviousSelectedButton!=null)
			GUISchematicEditor_Toolbar.PreviousSelectedButton.setSelected(false);
	}
		...
		buttonRemovePart.addActionListener(new  ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				if(CommonData.partsSelected.size()==1) {
					CommonData.scheme.removeElement(CommonData.partsSelected.get(0));
					CommonData.partsSelected.clear();
				}else
					CommonData.scheme.removeElements(CommonData.partsSelected);
